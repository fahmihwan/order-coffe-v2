                            ...
                            <li className="nav-item">
                                <div className="nav-link d-flex">
                                    ...
                                    <div className="nav-item dropdown">
                                        ...
                                        >
                                            <a className="dropdown-item" href="#">
                                                <i className="flag-icon flag-icon-bl mr-3" /> French{" "}
                                            </a>
                                            <div className="dropdown-divider" />
                                            <a className="dropdown-item" href="#">
                                                <i className="flag-icon flag-icon-cn mr-3" /> Chinese{" "}
                                            </a>
                                            <div className="dropdown-divider" />
                                            <a className="dropdown-item" href="#">
                                                <i className="flag-icon flag-icon-de mr-3" /> German{" "}
                                            </a>
                                            <div className="dropdown-divider" />
                                            <a className="dropdown-item" href="#">
                                                <i className="flag-icon flag-icon-ru mr-3" />
                                                Russian{" "}
                                            </a>
                                        </div>
                                    </div>
                    ...
                    <div className="content-wrapper pb-0">
                        <div className="page-header flex-wrap">
                            <div className="header-left">
                                <button className="btn btn-primary mb-2 mb-md-0 mr-2">
                                    {" "}
                                    Create new document{" "}
                                </button>
                                    ...
                                    <div className="card-body">
                                        <div className="d-flex justify-content-between">
                                            ...
                                            <div className="d-flex text-muted font-20">
                                                ...
                                                <i className="mdi mdi-help-circle-outline ml-2 mouse-pointer" />
                                            </div>
                                        </div>
                                ...
                                <div className="card">
                                    ...
                                    <div className="card-body px-3 text-dark">
                                        ...
                                        <div className="d-flex justify-content-between font-weight-semibold">
                                            <p className="mb-0">
                                                <i className="mdi mdi-star star-color pr-1" />
                                                4.60 (35){" "}
                                            </p>
                            ...
                            <div className="col-xl-8 stretch-card grid-margin">
                                <div className="card">
                                    ...
                                    <div className="card-body p-0">
                                        ...
                                        <a
                                            className="text-black d-block pl-4 pt-2 pb-2 pb-lg-0 font-13 font-weight-bold"
                                            href="#"
                                        >
                                            Show more
                                        </a>

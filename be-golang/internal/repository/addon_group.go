...
func (r *AddOnGroupRepository) List(ctx context.Context, filter FilterAddon) (res []*model.AddOnGroup, total int, err error) {
...
func (r *AddOnGroupRepository) setFilter(db *gorm.DB, filter FilterAddon) *gorm.DB {
	if filter.ID != nil {
